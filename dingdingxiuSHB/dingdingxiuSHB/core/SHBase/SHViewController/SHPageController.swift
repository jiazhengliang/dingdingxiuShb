...
class SHPageController: SHBaseController {

    var pageStyle: SHUPageStyle!
    ...
    convenience init(titles:[String] = [],vcs:[ViewController] = [],pageStyle: SHUPageStyle = .none ) {
        self.init()
        self.titles = titles;
        self.vcs = vcs
...
extension SHPageController: UIPageViewControllerDataSource, UIPageViewControllerDelegate {
    func pageViewController(_ pageViewController: UIPageViewController, viewControllerBefore viewController: UIViewController) -> UIViewController? {
        guard let index = vcs.firstIndex(of: viewController) else {
            return nil
        }
        
        let befareIndex = index - 1
        
        guard befareIndex >= 0 else {
            return nil
        }
        
        return vcs[befareIndex]
