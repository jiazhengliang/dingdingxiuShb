...
let timeoutClosure = {(endpoint: Endpoint, closure: MoyaProvider<SHUapi>.RequestResultClosure) -> Void in
...
let ApiProvider = MoyaProvider<SHUapi>(requestClosure: timeoutClosure)
let ApiLoadingProvider = MoyaProvider<SHUapi>(requestClosure: timeoutClosure, plugins: [LoadingPlugin])
